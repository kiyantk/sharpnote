...
const EditPopup = ({
  ...
  const [editedNoteToDisplay, setEditedNoteToDisplay] = useState({
    ...noteToEdit,
  });
  ...
  const handleReadonlyInputChange = (event) => {
    const newSetting = {
      ...editedNoteToSave,
      isReadonly: event.target.checked ? 1 : 0,
    };
          ...
          <div>
            ...
            <div className="editnote-popup-content">
              <div className="editnote-popup-item">
                ...
                <input
                  type="text"
                  className="editnote-input editnote-titleinput"
                  value={editedNoteToDisplay.noteTitle}
                  maxLength={100}
                  onChange={handleTitleInputChange}
                ></input>
                <span className="welcome-popup-username-requirements">
              ...
              <div className="editnote-popup-item">
                ...
                <div className="noteColor-editcontainer">
                  <div
                    style={{
                      backgroundColor: editedNoteToDisplay.noteColor,
                      width: "30px",
                      height: "30px",
                      borderRadius: "4px",
                  ...
                  <input
                    ...
                    value={editedNoteToDisplay.noteColor}
              ...
              <div className="editnote-popup-item">
                ...
                <div className="noteColor-editcontainer">
                  <input
                    ...
                    checked={!!editedNoteToDisplay.isReadonly}
            ...
            <div className="editnote-popup-content">
              <div className="editnote-popup-item">
                ...
                <input
                  type="text"
                  className="editnote-input editnote-titleinput"
                  value={editedNoteToDisplay.folderTitle}
                  maxLength={100}
                  onChange={handleTitleInputChange}
                ></input>
                <span className="welcome-popup-username-requirements">
              ...
              <div className="editnote-popup-item">
                ...
                <div className="noteColor-editcontainer">
                  <div
                    style={{
                      backgroundColor: editedNoteToDisplay.folderColor,
                      width: "30px",
                      height: "30px",
                      borderRadius: "4px",
                      border: "1px solid #ccc",
                  ...
                  <input
                    type="color"
                    className="editnote-input"
                    value={editedNoteToDisplay.folderColor}
                    onInput={handleColorInputChange}
                  ></input>
                </div>
              </div>
