          ...
          <div className="editnote-popup-item">
            ...
            <div className="welcome-popup-username-container">
              ...
              <span className="welcome-popup-username-requirements">
                Optional<br></br>a-Z, 0-9, -, _ and spaces. Up to 32 characters
              </span>
            </div>
            <span className="welcome-popup-username-explaining">
              This information is optional and will only be stored on your
              device.<br></br>It will be used as the note Author in your notes
              to log the creator.
            </span>
          </div>
        </div>
